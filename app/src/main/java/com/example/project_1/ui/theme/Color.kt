...
val DarkGreen = Color(0xFF00695c)
val lime = Color(0xFFf9fbe7)
val greens1 = Color(0xFFb2dfdb)
val lightWhite = Color(0xFFeeeeee)
val lightblue = Color(0xff18ffff)
val pink = Color(0xFFE43F77)
val darkpink = Color(0xFFF50057)
val darkkpink = Color(0xFFD5034A)
/*
    BLUE LIGHT PALETTE
 */
